...
<div class="container-fluid" style="background-color:#C2D1EB;">
  <div class="row" style="padding:9vh 9vw 13vh">
    <div class="card-deck" >
      <div class="card">
        <div class="card-body">
          <h4 class="card-title py-3 text-center" style="color:#2f2c40"><strong>最新消息</strong></h4>
      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title py-3 text-center" style="color:#2f2c40"><strong>最新活動</strong></h4>
      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title py-3 text-center" style="color:#2f2c40"><strong>最新成果展消息</strong></h4>
