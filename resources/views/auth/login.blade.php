...
<div class="row justify-content-center m-0">
    <div class="col-md-6 p-0" style="position: relative;">
        <div class="card bg-lg" style="top:50%;">
            <!-- <div class="card-header">{{ __('Login') }}</div> -->
            <div class="card-body py-5">
            <h3 class="text-center pb-5 logo"><strong> 群 青 </strong></h3>
                <form class="m-0" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-8 offset-md-4">
                            <button type="submit" class="btn button-c1">
                                {{ __('Login') }}
                            </button>

                            @if (Route::has('password.request'))
                            <a class="btn a-col-d" href="{{ route('password.request') }}">
